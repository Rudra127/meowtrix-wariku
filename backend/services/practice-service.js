  ...
  return [
    {
      ...
      content: [
        ...
        "",
        "Wording (the learner reads this, so it must not sound machine-written):",
        "- No em dashes or en dashes. End the sentence, or use a comma.",
        "- Plain words only. Never: crucial, delve, elevate, empower, enhance, essential to note,",
        "  leverage, pivotal, robust, seamless, utilize, vital.",
        '- No filler in explanations: drop "It is important to note that", "Remember that",',
        '  "Keep in mind that". State the reason directly.',
        "- Explanations are one sentence, active voice, with the number in it where there is one.",
        '  "72 divided by 12 is 6 years" beats "this demonstrates the power of compounding".',
      ].join("\n"),
    },
    {
      role: "user",
